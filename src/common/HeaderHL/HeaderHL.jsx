...
const HeaderHL = () => {
  ...
  // console.log('acces', JSON.par(access_token))
      ...
      <div className='box-search'>
        <div className='search'>
          ...
          <select
            ...
            <option value='suggest' disabled>Gợi ý</option>
        ...
        {Array.isArray(results) && showResults && (
          <SearchResultList result={results} clearSearch={handleClearSearch} />
        )}
